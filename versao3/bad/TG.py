...
class tgApp(object):
    def __init__(self):
        ...
        self.window.set_size_request(1000,600) # largura X altura
        ...
        self.image_black.set_from_file('glade/imgs/black.png')
        self.image_black.show()

        #teste=['glade/imgs/happy2.png','glade/imgs/happy.png','glade/imgs/happy3.png']
        #n=randint(0,2)
        ...
        self.window.show()
        self.happy = self.builder.get_object("black")
        self.sad = self.builder.get_object("doubt")
    ...
    def clear_text(self, widget):
        ...
        self.image_happy.show()
        self.image_sad.set_from_file('glade/imgs/sad2.jpg')
        self.image_sad.show()
        self.image_doubt.set_from_file('glade/imgs/duvida.png')
        self.image_doubt.show()
