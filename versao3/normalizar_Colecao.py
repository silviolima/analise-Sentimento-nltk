...
def carregar_stopWords():
    ...
    stopWords.append("aecio")
    stopWords.append("serra")
    stopWords.append("rousseff")
    stopWords.append("angela")
    stopWords.append("merkel")
...
'henrique','historia','hoje','para','copa','inacio','isso','ja','janeiro','jogo','jose','juros','justica','lado','lei','livro',
...
'paulo','pela','pelo','pelos','periodo','pesquisa','pessoas','plano','pode','podem','policia','politica','pontos','por','porque','pouco',
...
'todas','todo','todos','trabalho','tres','tudo','ultimo','um','uma','us','vai','valor','vao','vem','vez','vezes','vida','voce','zona','url','rt',
'n','new','atah','aeci','sao','blog','segunda','terca','quarta','quinta','sexta','sabado','hahah','via','q','raphael']
...
def normalizar(line):
    ...
    # Frase
    #Unicode caracter
    CoracaoBlack='\xe2\x99\xa5'
    CoracaoWhite='\xe2\x99\xa1'
    SmilingWhite='\xe2\x98\xba'
    SmilingBlack='\xe2\x98\xbb'
    TristeWhite='\xe2\x98\xb9'
   ...
   # Maiscula somente a primeira letra
    #w = w.capitalize()
    #print("\nMsg normalizada: %s \n" %w)
    if CoracaoBlack in frase3 or CoracaoWhite in frase3:
        return w + 'paixao'
    elif SmilingWhite in frase3 or SmilingBlack in frase3:
        return w + 'feliz'
    elif TristeWhite in frase3:
        return w + 'triste'
    return w 
